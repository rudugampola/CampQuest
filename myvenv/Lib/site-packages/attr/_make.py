    ...
    for a in attrs:
        ...
        if was_kw_only is True and a.kw_only is False:
            raise ValueError(
                ...
                "keyword-only attribute.  Attribute in question: {a!r}".format(a=a)
            )
...
class _ClassBuilder(object):
    ...
    def __init__(
        self, cls, these, slots, frozen, weakref_slot, auto_attribs, kw_only, cache_hash
    ):
...
def attrs(
    ...
    def wrap(cls):
        ...
        builder = _ClassBuilder(
            cls, these, slots, frozen, weakref_slot, auto_attribs, kw_only, cache_hash
        )
