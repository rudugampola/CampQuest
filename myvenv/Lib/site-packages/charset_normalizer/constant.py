...
UNICODE_RANGES_COMBINED: Dict[str, range] = {
    ...
    "Tangut": range(94208, 100_352),
    "Tangut Components": range(100_352, 101_120),
    "Khitan Small Script": range(101_120, 101_632),
    "Tangut Supplement": range(101_632, 101_760),
    "Kana Extended-B": range(110_576, 110_592),
    "Kana Supplement": range(110_592, 110_848),
    "Kana Extended-A": range(110_848, 110_896),
    "Small Kana Extension": range(110_896, 110_960),
    "Nushu": range(110_960, 111_360),
    "Duployan": range(113_664, 113_824),
    "Shorthand Format Controls": range(113_824, 113_840),
    "Znamenny Musical Notation": range(118_528, 118_736),
    "Byzantine Musical Symbols": range(118_784, 119_040),
    "Musical Symbols": range(119_040, 119_296),
    "Ancient Greek Musical Notation": range(119_296, 119_376),
    "Kaktovik Numerals": range(119_488, 119_520),
    "Mayan Numerals": range(119_520, 119_552),
    "Tai Xuan Jing Symbols": range(119_552, 119_648),
    "Counting Rod Numerals": range(119_648, 119_680),
    "Mathematical Alphanumeric Symbols": range(119_808, 120_832),
    "Sutton SignWriting": range(120_832, 121_520),
    "Latin Extended-G": range(122_624, 122_880),
    "Glagolitic Supplement": range(122_880, 122_928),
    "Cyrillic Extended-D": range(122_928, 123_024),
    "Nyiakeng Puachue Hmong": range(123_136, 123_216),
    "Toto": range(123_536, 123_584),
    "Wancho": range(123_584, 123_648),
    "Nag Mundari": range(124_112, 124_160),
    "Ethiopic Extended-B": range(124_896, 124_928),
    "Mende Kikakui": range(124_928, 125_152),
    "Adlam": range(125_184, 125_280),
    "Indic Siyaq Numbers": range(126_064, 126_144),
    "Ottoman Siyaq Numbers": range(126_208, 126_288),
    "Arabic Mathematical Alphabetic Symbols": range(126_464, 126_720),
    "Mahjong Tiles": range(126_976, 127_024),
    "Domino Tiles": range(127_024, 127_136),
    "Playing Cards": range(127_136, 127_232),
    "Enclosed Alphanumeric Supplement": range(127_232, 127_488),
    "Enclosed Ideographic Supplement": range(127_488, 127_744),
    "Miscellaneous Symbols and Pictographs": range(127_744, 128_512),
    "Emoticons range(Emoji)": range(128_512, 128_592),
    "Ornamental Dingbats": range(128_592, 128_640),
    "Transport and Map Symbols": range(128_640, 128_768),
    "Alchemical Symbols": range(128_768, 128_896),
    "Geometric Shapes Extended": range(128_896, 129_024),
    "Supplemental Arrows-C": range(129_024, 129_280),
    "Supplemental Symbols and Pictographs": range(129_280, 129_536),
    "Chess Symbols": range(129_536, 129_648),
    "Symbols and Pictographs Extended-A": range(129_648, 129_792),
    "Symbols for Legacy Computing": range(129_792, 130_048),
    "CJK Unified Ideographs Extension B": range(131_072, 173_792),
    "CJK Unified Ideographs Extension C": range(173_824, 177_984),
    "CJK Unified Ideographs Extension D": range(177_984, 178_208),
    "CJK Unified Ideographs Extension E": range(178_208, 183_984),
    "CJK Unified Ideographs Extension F": range(183_984, 191_472),
    "CJK Compatibility Ideographs Supplement": range(194_560, 195_104),
    "CJK Unified Ideographs Extension G": range(196_608, 201_552),
    "CJK Unified Ideographs Extension H": range(201_552, 205_744),
    "Tags": range(917_504, 917_632),
    "Variation Selectors Supplement": range(917_760, 918_000),
    "Supplementary Private Use Area-A": range(983_040, 1_048_576),
    "Supplementary Private Use Area-B": range(1_048_576, 1_114_112),
}
